...
behavior. Reports can be made through GitHub by contacting the repository
maintainers. Maintainers will review reports promptly and fairly, and will
respect the privacy and security of the reporter.

Maintainers may remove comments, commits, code, wiki edits, issues, pull
requests, or other contributions that do not align with this Code of Conduct.
They may also temporarily or permanently ban contributors for behavior they deem
